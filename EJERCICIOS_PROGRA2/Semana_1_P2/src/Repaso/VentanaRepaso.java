...
//            boolean verificaTamanno= tamanno.matches("[3-9]");
//            boolean verificaHilera = hilera.matches("[^0-9] [a-z] [\\t\\n\\x0B\\f\\r]"); 
//            //&& hilera.matches("[a-z]")&& hilera.matches(" [\\t\\n\\x0B\\f\\r]") ;

//  Pattern patron=Pattern.compile("[a-z]");
//                     Pattern patron2= Pattern.compile("^[3-9]");
//                          Matcher valida1= patron.matcher(hilera);
//                          Matcher valida2= patron2.matcher(tamanno);
//                                     boolean hileraVal= valida1.matches();
//                                     boolean tamannoVal=valida2.matches();
//             
//                     if(hileraVal==true&&tamannoVal==true){