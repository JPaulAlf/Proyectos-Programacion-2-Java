...
public class Main_PRBS_CDG {
    ...
    public static void main(String[] args) throws ParseException {
        // TODO code application logic here
         ArrayList<Integer> arrayPuntajes= new ArrayList();
        arrayPuntajes.add(10);
//         arrayPuntajes.add(6);
//          arrayPuntajes.add(2);
        ...
        System.out.println(((( totalPuntaje/ (arrayPuntajes.size()+1) )*10)*2));
        System.out.println((totalPuntaje / arrayPuntajes.size()) * 10.0);
        System.out.println("*********************************************************************-----------");
