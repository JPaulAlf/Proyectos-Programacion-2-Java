...
public class Archivador_Usuarios {
    ...
    public static void llenoArrayUsuarios(){
        ...
        Usuario admin= new UsuarioAdministrativo("Administrador", "admin", "123",tarjeta);
        admin.agregarPerfil("Administrador");
        
        Usuario user1= new UsuarioCorporativo("Carlos", "carlos@gmail.com", "carlos", tarjeta1);
        user1.agregarPerfil("Maria");
        user1.agregarPerfil("Pablo");
        user1.agregarPerfil("Carla");
        
        Usuario user2= new UsuarioResidencial("Maria", "maria@gmail.com", "maria", tarjeta2);
