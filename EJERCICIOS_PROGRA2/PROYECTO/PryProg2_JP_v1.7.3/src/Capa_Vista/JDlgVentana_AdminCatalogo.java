...
public class JDlgVentana_AdminCatalogo extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jTxtNombreDirecto = new javax.swing.JTextField();
        ...
        jCbxNombreDirector.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Steven Spielberg", "Peter Jackson", "Martin Scorsese", "Steven Spielberg ", "Ingmar Bergman", "Roman Polanski ", "William Wyler ", "Terrence Malick ", "Fred Zinnemann", "John Lasseter ", "Lars von Trier", "Robert Zemeckis ", " " }));
        ...
        jPnlPeliculaSubLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPnlPeliculaSubLayout.createSequentialGroup()
                ...
                .addGroup(jPnlPeliculaSubLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addComponent(jTxtNombreDirecto, javax.swing.GroupLayout.Alignment.LEADING)
        ...
        jPnlPeliculaSubLayout.setVerticalGroup(
            ...
            .addGroup(jPnlPeliculaSubLayout.createSequentialGroup()
                ...
                .addComponent(jTxtNombreDirecto, javax.swing.GroupLayout.PREFERRED_SIZE, 29, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jTabbedPane1.setBounds(404, 105, 244, 261);
                 ...
                 Boolean esOriginal= this.jChxEsOriginal.isSelected();
                       ...
                       //========================CREACION OBJETOS=======================       
                                ...
                                if(this.jRbdPelicula.isSelected()){ // si el administrador selecciona crear una pelicula
                                     if(this.jTxtNombreDirecto.getText().isEmpty()){
                                        JOptionPane.showMessageDialog(this, "Favor ingresar un nombre de director valido" 
                                                , "ERROR ENCONTRADO:",JOptionPane.ERROR_MESSAGE);
                                         return;       
                                      }
                                    String director= this.jTxtNombreDirecto.getText();
 ...
 //-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  ...
  // <<<<<<<<<<<<<<<<<<<<<<<<<<<ACCIONES EXTRA>>>>>>>>>>>>>>>>>>>>>>>>>>>>
    ...
    public void opcionConsultar(){
        ...
        this.jTxtNombreDirecto.setEditable(false);
...
//    }
    ...
    private javax.swing.JTextField jTxtNombreDirecto;
