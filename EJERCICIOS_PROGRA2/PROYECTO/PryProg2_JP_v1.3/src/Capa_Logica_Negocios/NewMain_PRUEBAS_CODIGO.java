 ...
 * @author johnpaul
 */
public class NewMain_PRUEBAS_CODIGO {
    ...
    public static void main(String[] args) throws ParseException {
        ...
        Usuario usuario1= new UsuarioAdministrativo("Administrador", "admin", "123");
        Usuario usuario2=new UsuarioResidencial("Juan Carlos", "juan11@hotmail.com", "contrasenna", "5390395583964086", TIPO_TARJETA.MASTER_CARD);
        Usuario usuario3=new UsuarioCorporativo("Maria Laura", "maria22@hotmail.com", "holamundo", "4485736190468137", TIPO_TARJETA.VISA);
        ...
        ContenidoAudioVisual cont1 = new ContenidoPelicula(true,"Silvester Stallone", true, "12-34", "ROCKY 4",LocalDateTime.of(2019,3, 1, 1, 1),60);
